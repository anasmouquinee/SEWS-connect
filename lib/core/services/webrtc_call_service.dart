...
class WebRTCCallService {
  ...
  static Future<String> startCall({
    ...
    if (kIsWeb) {
      // Start the WebRTC call first (this generates the channel ID)
      final channelId = await WebRTCCallServiceWeb.startCall(
        userId: callerId,
        audioOnly: audioOnly,
      );
      
      // Send call invitation with the generated channel ID
      debugPrint('🔔 Sending call invitation: callerId=$callerId, calleeId=$calleeId, calleeName=$calleeName, channelId=$channelId');
